...
in the production build only. A separate bindle for vendor code
...
cached until one of them changes. So basically this avoids customers having to download
a huge JS file anytime a line of code changes. They only have to download vendor.js when
